...
namespace UAS
{
    public partial class KodeWarnaInduktor : Form
    {
        public KodeWarnaInduktor()
        {
            InitializeComponent();
        }
        ...
        public void Hitung()
        {
            label1.Text = textBox1.Text + textBox2.Text + textBox5.Text + textBox4.Text;
        }
        ...
        private void KodeWarnaInduktor_Load(object sender, EventArgs e)
        {
